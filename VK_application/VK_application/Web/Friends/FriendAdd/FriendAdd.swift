...
class FriendAdd {
    ...
    func getAddFriend(userID: Int, completion: @escaping (Result<FriendAddModel, FriendsServiceError>) -> Void) {
    ...
    private func getAddFriendError(userID: Int, param: Parameters,
                                   completion: @escaping (Result<ErrorModel, FriendsServiceError>) -> Void) {
