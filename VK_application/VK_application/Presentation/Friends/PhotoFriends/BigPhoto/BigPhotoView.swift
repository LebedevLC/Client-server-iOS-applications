...
class BigPhotoView: UIView, UIGestureRecognizerDelegate {
    ...
    var photoInfo = [Int:(String, URL, Int, Int, Int)]()
...
//MARK: - Photo
    ...
    private func setPhotos() {
        ...
        let urlVisibleView = photoInfo[visibleIndex]!.1
        let urlLeftView = photoInfo[earlyIndex()]!.1
        let urlRightView = photoInfo[nextIndex()]!.1
